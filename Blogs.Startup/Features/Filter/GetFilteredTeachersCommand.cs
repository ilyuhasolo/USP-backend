...
{
    public class GetFilteredTeachersCommand : IRequest<IReadOnlyList<Core.Domain.Model.Person?>>
    {
    ...
    public class GetFilteredTeachersCommandHandler : IRequestHandler<GetFilteredTeachersCommand, IReadOnlyList<Core.Domain.Model.Person?>>
    {
        ...
        public async Task<IReadOnlyList<Core.Domain.Model.Person?>> Handle(GetFilteredTeachersCommand request, CancellationToken cancellationToken)
        {
            ...
            return res
                ...
                .Where(p => request.Name == null || p.Login == request.Name)
